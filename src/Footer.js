        ...
        <div>
          <Grid container justify="space-around">
						<Grid item lg={1} sm={1} xs={9}>
								<Typography variant="h4" className={classes.styleh4} style={{color : '#2196F3', fontWeight : '600'}}> About Us </Typography>
								<span style={{backgroundColor:'#2196F3',height:'5px', width:'90px',position:'absolute',margin:'5px 0px',marginLeft:'-20px'}}></span>
